...
public class UserDAO {
    ...
    public User getUser(int id) {
        try {
            String query = "SELECT user_id, username, password, firstname, lastname, gender, icon_name FROM users WHERE user_id = ? AND active = true";
    ...
    public List<User> getAll() {
        ...
        try {
            ...
            while (result.next()) {
                ...
                users.add(new User(id, username, password, firstname, lastname, gender, icon));
            }
        } catch (Exception e) {
    ...
    public User loginUser(String username, String password) {
        try {
            String query = "SELECT user_id, username, password, firstname, lastname, gender, icon_name FROM users WHERE username = ? AND password = ? AND active = true";
    ...
    public User addUser(String username, String password, String firstname, String lastname, String gender, int icon) {
        try {
            String query = "INSERT INTO users (USERNAME, PASSWORD, FIRSTNAME, LASTNAME, GENDER, ICON_NAME) VALUES (?, ?, ?, ?, ?, ?)";
